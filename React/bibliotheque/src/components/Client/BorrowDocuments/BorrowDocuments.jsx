...
const customStyles = {
    header: {
        ...
        style: {
            borderTopStyle: 'solid', borderTopWidth: '1px', borderTopColor: 'black',
        },
    }, Cells: {
        style: {
            borderBottomStyle: 'solid', borderBottomWidth: '1px', borderBottomColor: 'black',
        },
    },
};
...
export default function BorrowDocuments() {
    ...
    const ExpandedBorrow = ({data}) => <pre style={{'width': 1000 + 'px', 'paddingLeft': '20px'}}>
        <h3>Document :</h3>
        <DataTable
    ...
    const contextReturnBorrows = React.useMemo(() => {
        ...
        return (<button onClick={returnBorrows}>
            Retourné Emprunt
        </button>)
    ...
    return (<>
        ...
        {borrows && <div className="containerBorrowDocs">
            <br/><br/>
            <DataTable
